...
export default function ContactHead() {
  return (
    <div
      className="flex flex-col items-center justify-center md:mt-20 mt-20"
      id="contact"
    >
      {/* Creative Heading */}
      <motion.h1
      ...
      >
        Reach out to Everpeak Lodge for exceptional service, inquiries, or
        reservations - your mountain getaway awaits!{" "}
      </motion.p>
    </div>
  );
}
